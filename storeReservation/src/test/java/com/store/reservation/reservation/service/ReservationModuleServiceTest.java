...
//import com.store.reservation.store.store.domain.vo.location.Coordinate;
...
//                .build();
//
//        MemberInformation manager = MemberInformation.builder()
//                .id(2L)
//                .name("고길동")
...
//                .storeId(1L)
//                .storeName("와이앤웍")
//                .coordinate(new Coordinate(126, 30, "우리나라 어딘가"))
//                .foods(new ArrayList<>())
...
////                .build();
////
////        MemberInformation customer2 = MemberInformation.builder()
////                .memberId(2L)
////                .name("고길동")
////                .email("ggildong@gmail.com")
////                .password("1234567")
