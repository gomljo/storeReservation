...
//import com.store.reservation.member.memberInfo.domain.type.Role;
//import com.store.reservation.member.memberInfo.security.CustomUserDetailService;
//import com.store.reservation.member.memberInfo.service.MemberServiceImpl;
...
//
//    private MemberInformation manager;
//    private Store store;
//
//
...
//                .build();
//
//        manager = MemberInformation.builder()
//                .id(1L)
//                .name("홍길동")
//                .email("xxx@email.com")
...
//                .manager(manager)
//                .starRating(4.0)
//                .coordinate(jusoOpenApi.convertToCoordinateFrom("경기도 수원시 권선구 매곡로 88"))
